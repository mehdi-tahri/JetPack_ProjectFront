...
var ReactPreset = /** @class */ (function () {
    function ReactPreset() {
        ...
        this.tsxDependencies = ['@stryker-mutator/typescript'].concat(this.generalDependencies);
        this.tsxConf = "{\n      mutate: ['src/**/*.ts?(x)', '!src/**/*@(.test|.spec|Spec).ts?(x)'],\n      mutator: 'typescript',\n      " + this.sharedConfig + "\n    }";
        this.jsxDependencies = ['@stryker-mutator/javascript-mutator'].concat(this.generalDependencies);
