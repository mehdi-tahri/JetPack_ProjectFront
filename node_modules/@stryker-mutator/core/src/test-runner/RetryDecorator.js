...
var RetryDecorator = /** @class */ (function (_super) {
    ...
    function RetryDecorator() {
        ...
        _this.log = log4js_1.getLogger(RetryDecorator.name);
        return _this;
    }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        _a.sent();
                        return [2 /*return*/, { status: test_runner_1.RunStatus.Error, errorMessages: [ERROR_MESSAGE + util_1.errorToString(lastError)], tests: [] }];
