...
var SandboxPool = /** @class */ (function () {
    ...
    SandboxPool.prototype.startSandboxes = function () {
        ...
        return rxjs_1.range(0, concurrency).pipe(operators_1.flatMap(function (n) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (this.isDisposed) {
                    return [2 /*return*/, null];
                }
                else {
                    return [2 /*return*/, this.registerSandbox(Sandbox_1.default.create(this.options, n, this.initialFiles, this.testFramework, this.overheadTimeMS, this.loggingContext))];
                }
                return [2 /*return*/];
            });
        }); }, MAX_CONCURRENT_INITIALIZING_SANDBOXES), operators_1.filter(function (sandboxOrNull) { return !!sandboxOrNull; }), operators_1.map(function (sandbox) { return sandbox; }));
    };
    ...
    SandboxPool.prototype.dispose = function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(this.allSandboxes)];
                    case 1:
                        sandboxes = _a.sent();
