...
var config_1 = require("@stryker-mutator/api/config");
var plugin_1 = require("@stryker-mutator/api/plugin");
var util_4 = require("@stryker-mutator/util");
var di_1 = require("../di");
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new util_3.StrykerError(util_4.normalizeWhitespaces("Cannot determine input files. Either specify a `files`\n        array in your stryker configuration, or make sure \"" + process.cwd() + "\"\n        is located inside a git repository"), error_1);
